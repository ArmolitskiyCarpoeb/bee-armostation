...
/obj/item/integrated_circuit_old/input/clowndetector
	complexity = 18
	name = "Clown Finder"
	desc = "Находит человекоподобное существо с генами клоунов и сообщает об этом."
	extended_desc = "Обнаруживает клоунов. И возможно мимов."
